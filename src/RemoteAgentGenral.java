...
public class RemoteAgentGenral implements Agent{
    ...
    public void init(Collection<String> percepts){
        ...
        SearchType search_type = SearchType.BFS;
        // parse the input
        actionSequence = parseInputAndRunSearch(percepts, search_type);
    }

    public String nextAction(Collection<String> percepts){
    	if (!actionSequence.empty() && actionSequence != null) {
            Action a = actionSequence.pop();
            if (a == null) {
                return "TURN_ON";
            }
            else {
